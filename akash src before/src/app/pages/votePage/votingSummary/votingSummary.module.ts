...
import { VotingSummaryRoutingModule } from './votingSummary-routing.module';
...
@NgModule({
  ...
  imports: [VotingSummaryRoutingModule, ...modules],
  declarations: [VotingSummaryComponent],
  exports: [VotingSummaryComponent]
})
export class VotingSummaryModule { }
